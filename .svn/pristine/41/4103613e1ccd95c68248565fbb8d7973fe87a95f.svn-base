...
input[type='radio']:checked {
  background-color: pink;
	...
	<div class="container">
	<div>
	<form action="${pageContext.request.contextPath}/event/eventInsert" method="post" enctype="multipart/form-data">
<!-- 이벤트제목<input name="evt_title" type="text" /><br> -->
<label>< 이벤트 제목 > </label><input class="form-control" type="text" name="evt_title" id="searchWord" /><br>

<label>< 이벤트 내용 > </label><textarea name="evt_content"></textarea><br>
...
<div class="form-group row">
			...
			<div class="col-md-10">
				<input name="evt_date" class="form-control" type="date" value="2011-08-19T13:45:00" id="example-datetime-local-input">
			</div>
		</div>
...
<div class="form-check ">
 <label for = "evt_qualification">참가자격 : </label>
		<input id="radio-3" class="radio-custom form-check-input" name="evt_qualification" value = "고졸" type="radio" checked>
		...
		<input id="radio-3" class="radio-custom form-check-input" name="evt_qualification" value = "대졸" type="radio" checked>
...
<div class="form-check ">
 <label for = "evt_qualification1">주최기관별 : </label>
		...
		<input id="radio-3" class="radio-custom form-check-input" name="evt_organizer" value = "공기업" type="radio" checked>
		...
		<input id="radio-3" class="radio-custom form-check-input" name="evt_organizer" value = "중앙정부/기관" type="radio" checked>
		<label for="radio-3" class="radio-custom-label form-check-label">중앙정부/기관</label>
		<input id="radio-3" class="radio-custom form-check-input" name="evt_organizer" value = "해외" type="radio" checked>
