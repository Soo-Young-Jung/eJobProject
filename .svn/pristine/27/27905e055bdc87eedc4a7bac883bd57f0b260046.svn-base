			...
			<div class="container">
				...
				<div class="navbar-collapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown drop_single ">
							<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">공고관리</a>
							<ul class="dropdown-menu dd_first">
								<li><a id="annListTop" href="#">나의 공고리스트</a></li>
								<li><a id="writeTop" href="#">공고 글쓰기</a></li>
							</ul>
						</li>
