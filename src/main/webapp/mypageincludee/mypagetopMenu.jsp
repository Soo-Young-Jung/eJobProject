			...
			<div class="container">
				...
				<div class="navbar-collapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown drop_single ">
							<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">스크랩</a>
							<ul class="dropdown-menu dd_first">
								<li id="scrapTop"><a href="#">스크랩한 공고</a></li>
							</ul>
						</li>
