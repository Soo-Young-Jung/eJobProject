...
<!--                         <div class="col-md-2"> -->
<!-- 							<div class="form-group"> -->
<!-- 								<input id="searchBtn" type="submit" value="검색" class="btn form-control btn-primary btn-block" > -->
<!-- 							</div> -->
<!--             	        </div> -->
<!--                 	</div> -->
						...
						<div class="card card-style3">
							...
							<div class="card-block">
								<ul class="list-inline">
									<li>
										<a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> <span class="text-primary">${announce.ent_name}</span></a>
									</li>
									<li>
										<a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i> ${announce.scrapCount}</a>
									</li>
								</ul>
...
<%-- 				<button type="button" onclick="location.href='<c:url value="/announce/announceForm.do"/>';" >공고 채용글 올리기</button> --%>
<!-- 		<div style="float: right;"> -->
<%-- 			<c:if test="${mem_div eq 'G'}"> --%>
<%-- 				<button type="button" onclick="location.href='<c:url value="/announce/announceForm.do"/>';" >공고 채용글 올리기</button> --%>
<%-- 			</c:if> --%>
<!-- 		</div> -->
