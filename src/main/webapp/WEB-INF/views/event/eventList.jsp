...
<div class="row justify-content-center">
		<div class="col-md-2">
			<select id="searchType" class="form-control" style="height: 50px; margin-bottom: 50px;">
		...
		<div class="col-md-2">
			<input type="button" value="검색" id="searchBtn" style="color: white;" class="btn form-control btn-danger btn-block"/>
		</div>
</div>
</div>
...
<div class="container" >
<div class="row justify-content-center">
<c:set value="${pagingVO.dataList }" var="eventList"/>
				<c:choose>
     			 ...
     			 <h4 class="card-title">
     				  ${event.evt_title }
							...
							<span>${event.evt_content }</span>
								...
								<span><button style="width:300px;" class="btn btn-sm mt-3 btn-danger" value="${event.evt_no }" >이벤트 보러가기!!</button></span>
