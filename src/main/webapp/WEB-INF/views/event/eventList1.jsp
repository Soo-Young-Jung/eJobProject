...
<!-- </div> -->
	...
	<button id="id1" class="btn btn-danger-outlined" type="submit" value="공기업">공기업</button>
	<button id="id2" class="btn btn-danger-outlined" type="submit" value="대기업">대기업</button>
	<button id="id3" class="btn btn-danger-outlined" type="submit" value="중앙정부/기관">중앙정부/기관</button>
	<button id="id4" class="btn btn-danger-outlined" type="submit" value="해외">해외</button>
...
<script type="text/javascript">
	...
	$(".btn").on("click", function(){
		...
		location.href="<c:url value='/event2'/>?evt_organizer=" + $(this).prop("value");
