...
<c:if test="${not empty message }">
	...
	<c:url value="/faq/faqDelete.do" var="faqBoardUrl">
		<c:param name="what" value="${faq.faq_no }" />
	</c:url>
	<input type="button" id="faqDelBtn" value="글삭제" class="btn btn-danger-outlined"
		onclick="location.href='${faqBoardUrl}';"
	/>
	
	<c:url value="/faq/faqUpdate.do" var="updateFaqUrl">
		<c:param name="what" value="${notice.not_no }" />
	</c:url>
	<input type="button" id="" value="수정하기" class="btn btn-danger-outlined"
		onclick="location.href='${updateFaqUrl}';"
	/>
	</c:if>
