			...
			<div class="container">
				...
				<div class="navbar-collapse">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown drop_single ">
							<a id="event" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">공모전 </a>
						</li>

						<li class="nav-item dropdown drop_single ">
							<a class="nav-link dropdown-toggle" id="blog"
					...
					$(alarmList).each(function(idx, alarm){
						...
						if(alarm.al_div==1){
							innerTrs.push(
								$("<tr>").append(
									$("<td>")
									.text(alarm.mem_id2+"님이 회원님의 게시글 "+alarm.bc_title+"에 댓글을 남기셨습니다.")
								)
							);
